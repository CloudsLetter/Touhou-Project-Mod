...
public static class Globals
{
    ...
    public static Models.Status YouyoumuStatus = new() { PlayersOriginalBytes = new byte[3], BombOriginalBytes = new byte[3], PowerOriginalBytes = new byte[3], InvincibleOriginalBytes = new byte[10] };
    public static Models.Status EiyashouStatus = new() { PlayersOriginalBytes = new byte[3], BombOriginalBytes = new byte[6], PowerOriginalBytes = new byte[3], InvincibleOriginalBytes = new byte[10] };
